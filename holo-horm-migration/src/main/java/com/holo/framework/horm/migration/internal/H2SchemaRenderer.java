...
/**
 * H2 数据库 Schema 渲染器（MODE=MySQL 兼容）。
 */
public final class H2SchemaRenderer implements SchemaRenderer {
    ...
    public String renderModifyColumn(String tableName, ColumnDefinition column) {
        return "ALTER TABLE " + tableName + " ALTER COLUMN " + renderColumnDefinition(column);
    }
    ...
    public String renderRenameColumn(String tableName, String oldName, String newName) {
        return "ALTER TABLE " + tableName + " ALTER COLUMN " + oldName + " RENAME TO " + newName;
    }
